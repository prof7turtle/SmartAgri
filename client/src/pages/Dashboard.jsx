    ...
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
        ...
        <div className="inline-flex items-center space-x-3">
          <span className="text-sm text-gray-600">Last updated: Today, 10:45 AM</span>
          <button className="px-4 py-2 bg-green-50 text-green-700 hover:bg-green-100 rounded-md transition duration-200 flex items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gray-50 rounded-lg p-5 border border-gray-100 hover:border-green-300 transition-colors">
                <div className="flex items-center mb-3">
                  ...
                  <div className="text-sm text-gray-500 font-medium">Farm Name</div>
                </div>
