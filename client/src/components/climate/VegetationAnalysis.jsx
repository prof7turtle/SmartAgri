      ...
      {loading || vegetationIndices.loading ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-5 rounded-lg shadow-lg border border-gray-100">
            ...
            <div className="mb-4 p-3 bg-green-50 rounded-md text-sm border-l-4 border-green-400">
              <p className="font-medium">Current nutrient profile based on vegetation indices and field samples</p>
            </div>
            
            <div className="h-72">
              <Bar 
                data={nutrientsChartData} 
                options={getChartOptions('Soil Nutrients Concentration', {
                  yAxisTitle: 'Value (ppm)',
                  beginAtZero: true
                })} 
            ...
            <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="p-2 border border-gray-200 rounded-md">
                ...
                <p className="text-lg font-bold text-green-800 mt-1">{keyObservations.nutrients.nitrogen.value} <span className="text-xs text-gray-500">ppm</span></p>
              </div>
              <div className="p-2 border border-gray-200 rounded-md">
                <div className="flex items-center justify-between">
                ...
                <p className="text-lg font-bold text-orange-700 mt-1">{keyObservations.nutrients.phosphorus.value} <span className="text-xs text-gray-500">ppm</span></p>
              </div>
              <div className="p-2 border border-gray-200 rounded-md">
                <div className="flex items-center justify-between">
                ...
                <p className="text-lg font-bold text-blue-700 mt-1">{keyObservations.nutrients.potassium.value} <span className="text-xs text-gray-500">ppm</span></p>
              </div>
              <div className="p-2 border border-gray-200 rounded-md">
                <div className="flex items-center justify-between">
                  <span className="text-sm font-semibold">Magnesium</span>
                ...
                <p className="text-lg font-bold text-purple-700 mt-1">{keyObservations.nutrients.magnesium.value} <span className="text-xs text-gray-500">ppm</span></p>
              </div>
            </div>
          </div>
